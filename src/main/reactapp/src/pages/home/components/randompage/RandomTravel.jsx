    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(
                "https://apis.data.go.kr/B551011/KorService1/areaBasedList1?serviceKey=yrgC%2B43SMF1XX%2Bb2wdT%2FLStUfM%2BUtudnH1zLiN40e0zQPaLsA7YUt6A1pdgBhSOE0YFbj0Q92OgugmuP9Yjcxg%3D%3D&numOfRows=10&pageNo=1&MobileOS=ETC&MobileApp=TestApp&_type=json"
            );
    ...
    return (
        <div>
            <div className="random-title">
                <span className="random-title-a">'K-Sketch'</span>
                <span className="random-title-b">표 쉬운 여행길잡이</span>
            </div>
                    ...
                    <div className="random-recipe-container-wrapper">
                        ...
                        <div className="my-random-dis2">
                            <div className={`random-recipe-content ${isActive ? "fade-in" : "fade-out"}`}>
                                ...
                                <div className="discrip-randompage">{randomItem.addr1}</div>
                                <div className="discrip-randompage">{randomItem.addr2}</div>
